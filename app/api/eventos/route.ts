      ...
      for (const prop of data.propiedades_afectadas) {
        ...
        try {
          ...
          const propiedadData = {
            ...
            nombre: propertyData.nombre || null,
            direccion: propertyData.direccion,
            property_number: propertyData.property_number || null,
          ...
          const result = await prisma.$queryRaw`
            INSERT INTO sisri.propiedades_existentes (property_type_id, nombre, direccion, property_number) 
            VALUES (
              ${propertyData.property_type_id},
              ${propertyData.nombre || null},
              ${propertyData.direccion || ''},
              ${propertyData.property_number || null}
            )
            RETURNING id
          `;
